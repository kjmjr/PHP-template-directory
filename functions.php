...
function shoreditch_scripts() {
	...
	wp_enqueue_style( 'css-file', get_template_directory_uri() . '/css/header.css', array(), '3.4.1' );
	
	wp_enqueue_style( 'js-file', get_template_directory_uri() . '/js/modernizr-custom.js', array(), '3.4.1' );
